...
CLUSTER_KEYS = ["data_pedido", "cliente_id", "canal_id"]
...
OPTIMIZATION_NOTES = {
    "optimize_write": "Reduce small file creation during write operations",
    "auto_compact": "Compact small files automatically after write",
    "liquid_clustering": "Improve read performance using the mart grain columns",
    "partitioning_strategy": "Not used to avoid unnecessary rigidity and maintenance overhead"
}
...
print("=" * 80)
print("STARTING GOLD PROCESSING: mart_customer_sales")
print("=" * 80)
...
validation = (
    ...
    .agg(
        ...
        F.countDistinct(
            F.concat_ws("||", "data_pedido", "cliente_id", "canal_id")
        ).alias("distinct_keys"),
